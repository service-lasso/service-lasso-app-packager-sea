...
console.log("[service-lasso-app-packager-sea] staged release artifacts");
...
console.log(`- runtime wrapper: ${result.artifacts.runtime.seaExecutablePath}`);
...
console.log(`- bundled wrapper: ${result.artifacts.bundled.seaExecutablePath}`);
